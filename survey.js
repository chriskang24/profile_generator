        ...
        rl.question("What's your favourite thing to eat for that meal?: ", (answer5) => {
          rl.question("Which sport is your absolute favourite?: ", (answer6) => {
            rl.question("What is your superpower? In a few words, tell us what you are amazing at!: ", (answer7) => {
              ...
              You like to listen to: ${answer3} while doing ${answer2} 
              Your favourite meal is: ${answer4}
              Your favorite thing to eat for ${answer4} is: ${answer5} 
              Your favourite sport is: ${answer6} 
              You told us that your superpower and amazing things about you are: ${answer7}`);
